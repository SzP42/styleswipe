...
<div class="w-screen h-auto flex flex-col items-center justify-center">
	...
	<div class="grid grid-cols-3 md:w-1/2 lg:w-1/3 w-5/6 h-10 ">
		...
		<div class="flex justify-end ">
			<button on:click={() => {swipe("right")}} class="bg-input_bg hover:bg-special_state_bg text-4xl border-2 border-dark_bg rounded-full size-16 "><img src="images/love icon.png" class="object-contain rounded-full" alt="like"></button></div>
		</div>
</div>